...
public class SarsaEpsilon implements ControlAgent {
    ...
    public SarsaEpsilon(double epsilon, double alpha, RLPolicyRenderer policyRenderer) {
        ...
        for (int e = 0; e < episodeCount; e++) {
            ...
            while (!env.isTerminal(s))
            {
                ...
                if (env.isTerminal(nextState))
                    ...
                    qNextSA =getQValue(env,nextState,nextAction);
                }
    ...
    static void demoPathFinding()
    {
        ...
        SarsaEpsilon sarsa = new SarsaEpsilon(0.1,0.5,new DeterministicPolicyRenderer());
